    ...
    <style>
        ...
        *{
        ...
        .header{
            position: relative;
            height: 100vh;
            background: url("../pic/2_1_header.png") no-repeat center center;
...
<body style="background-color: #8EC5FC;
    ...
    background-attachment: fixed;">
<center>
<div style="background: #80D0C7;height: 300px; width: 500px;">
    <br>
        发布人：<h1>${theQuestion.name}</h1><br>
        问题内容：<h2>${theQuestion.questionInfo}</h2><br>
    ...
    <div class="container">
        <center>
            ...
            <button type="button" class="layui-btn layui-btn-lg layui-btn-radius layui-btn-normal" style="background: #eb13d1">
                <a href="${pageContext.request.contextPath}/view/commentAdd_m">添加评论</a>
            </button>

            <button type="button" class="layui-btn layui-btn-lg layui-btn-radius layui-btn-normal" style="background: #eb13d1">
                <a href="${pageContext.request.contextPath}/view/community_m">返回社区</a>
            </button>
